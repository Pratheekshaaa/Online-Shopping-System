							...
							<div id="get_product_home2">
								...
								<div class="product-widget">
									...
									<div class="product-body">
										...
										<h4 class="product-price">RS9800.00 <del class="product-old-price">RS9900.00</del></h4>
									</div>
								</div>
								<!-- /product widget -->
							...
							<div>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
										<h4 class="product-price">RS98000.00 <del class="product-old-price">RS99000.00</del></h4>
									</div>
								</div>
								<!-- /product widget -->
